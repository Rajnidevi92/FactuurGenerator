    ...
    return (
        <div className={styles.pageWrapper}>
            <main className={styles.contentWrapper}>
                ...
                <p>2.1. U dient aanwijzingen van QuickHuisartsCheck op te volgen en ervoor te zorgen dat uw account
                    correct wordt gebruikt.</p>
                <p>2.2. De informatie in uw persoonlijke profiel kan onvolledig of onjuist zijn. Voor privacyrechten
                    zoals inzage, rectificatie, verwijdering of bezwaar, neem contact op met QuickHuisartsCheck.</p>

                <h2>Artikel 3: Rechten en plichten van QuickHuisartsCheck</h2>
                <p>3.1. QuickHuisartsCheck zorgt voor de beveiliging van uw gegevens en het correct functioneren van het
                    platform.</p>
                <p>3.2. QuickHuisartsCheck kan de functionaliteiten en beschikbaarheid van gegevens aanpassen.</p>
                <p>3.3. QuickHuisartsCheck verwerkt uw gegevens uitsluitend voor de doeleinden van de dienstverlening en
                    handelt conform de AVG.</p>
                <p>3.4. QuickHuisartsCheck kan niet garanderen dat het platform altijd beschikbaar is of foutloos
                    functioneert.</p>

                <h2>Artikel 4: Koppelingen en externe diensten</h2>
                <p>4.1. QuickHuisartsCheck kan koppelingen hebben met externe diensten. Voor deze diensten gelden de
                    voorwaarden van de betreffende aanbieder.</p>
                ...
                <ul>
                    ...
                    <li>5.2. Het platform gebruikt alleen noodzakelijke cookies; er worden geen persoonlijke gegevens
                        voor marketingdoeleinden verzameld.
                    </li>
                    <li>5.3. Alle intellectuele eigendomsrechten van QuickHuisartsCheck blijven bij QuickHuisartsCheck.
                        Niets uit de Voorwaarden mag worden gekopieerd of gedeeld zonder toestemming.
                    </li>
